...
test("el MCP público guarda sólo borradores explícitos, opacos y revisables", async () => {
  ...
  assert.match(route, /SERVER_VERSION = "0\.6\.0"/);
  assert.match(route, /CONTEXT_VERSION = "yol1-lab-context\/0\.5"/);
  ...
  assert.match(route, /guía universalmente a personas no técnicas/i);
