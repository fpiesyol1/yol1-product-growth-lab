export function createDemoResponse(question: string) {
  ...
  if (normalized.includes("mes") || normalized.includes("cambió")) return "Agosto deja un resultado de +$830.000: te entraron $2.450.000 y gastaste $1.620.000 según las categorías del ejemplo. No es un saldo bancario y las transferencias propias están excluidas por una regla simulada que puedes revisar.";
  ...
  return "No entendí bien esa pregunta. Prueba con una de estas: “¿Qué pasó con Disney+?”, “¿Quién me debe?” o “¿Qué beneficio tengo?”. Solo respondo sobre los datos ficticios de este ejemplo.";
}
