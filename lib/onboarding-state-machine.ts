...
export const ONBOARDING_STAGE_META: Record<OnboardingStage, { label: string; progress: number }> = {
  ...
  capability_chooser: { label: "Elegir un objetivo", progress: 2 / 7 },
  requirements_explained: { label: "Ver qué se necesita", progress: 3 / 7 },
  channel_select: { label: "Crear acceso", progress: 4 / 7 },
  otp_entry: { label: "Controlar canal", progress: 5 / 7 },
